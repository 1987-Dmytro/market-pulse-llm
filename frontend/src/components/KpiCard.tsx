 ...
 *
 * The value arrives as a STRING: the formatting is the caller's, because the caller is the one
 * holding the field and its unit. Colour never carries the status alone — the badge is an icon and
 * a word.
 */
