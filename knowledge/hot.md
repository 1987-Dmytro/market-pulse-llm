...
`61b4fda7fdc83197…`** — positions-50 размечать против ЭТОЙ sha. `make check` = **13 failed · 4 262 passed · 2 skipped ·
7 errors** (было 35 красных → 20, passed +15): **каждый красный — одна из двух вилок**, 19 — вилка 1, 1 — вилка 2.
7 редов от нового default `--window w2` были МОИ и ПОЧИНЕНЫ (хелперы НАЗЫВАЮТ окно своей фикстуры).
