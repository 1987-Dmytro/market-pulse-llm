...
`61b4fda7fdc83197…`** — positions-50 против ЭТОЙ sha. `make check` @ `b74123f` = **13 failed · 4 267 passed ·
7 errors** (35 → 20 красных, passed +20): каждый красный — вилка; счётная половина (j) ВЫПОЛНЕНА (4 267 ≥ 4 266),
