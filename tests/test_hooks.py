...
ACCEPTED = [
    "git add docs/STATUS.md docs/PROCESS.md",
    "git add -A-not-a-flag.txt",
    "git commit -m 'never git add -A: see CLAUDE.md'",
    "git commit -F msg.txt",
    "echo 'make fmt is forbidden'",
    "grep -rn 'ruff format .' docs/",
    "make check",
    "make preflight",
    "ruff format tests/test_hooks.py",
    "ruff check .",
]
