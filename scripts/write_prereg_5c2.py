...
3.21 (operator, 2026-08-15, the red-gate sitting) is the thirteenth, and it is the first one whose
contract named all four parts — Dv336 became the brief. It moves the matcher, which is the first
